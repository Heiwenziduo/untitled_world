...
object ModItems {
    ...
    { properties -> properties
        ...
        .component(ModDataComponents.WAND_HIGH_PAYLOAD, WandDataHighPayload.of(26)) }

    val TIERED_WAND: AbstractItemWand by DEFERRED_REGISTER.registerItem("tiered_wand", ::TieredWandItem)
    { properties -> properties
        .component(ModDataComponents.WAND_INVARIABLE, WandDataInvariable.DEFAULT)
        .component(ModDataComponents.WAND_HIGH_PAYLOAD, WandDataHighPayload.of(6)) }
