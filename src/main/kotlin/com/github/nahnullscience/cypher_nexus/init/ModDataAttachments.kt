...
object ModDataAttachments {
    ...
    { -> AttachmentType.builder { -> ItemWandInstanceMap() }.sync(WandDataSyncHandler).build() } // disable sync

    val WAND_MODULE_STATE_TRACKER = DEFERRED_REGISTER.register("wand_module_state_tracker")
