...
import com.github.nahnullscience.cypher_nexus.utility.mod.CNCodecs.ATTR_FAST_OPER_MAP_CODEC
...
data class CypherDataMap(
    ...
    open class Builder {
        ...
        open fun shotStateAttr(attr: CypherAttribute, operator: AttributeOperator, value: Double): Builder = apply {
            shotState.setAttribute(attr, operator, value)
        }
